...
const PublicationScreen = ({ route, navigation, userData }) => {
  ...
  // Accept multiple param names: `publication`, `post`, `postId`, or `id`.
  ...
  // Helper to read normalized fields from publication objects (so backend/frontend naming differences are handled)
  ...
  // backend may return object or array; normalize to single object
  let pub = data;
